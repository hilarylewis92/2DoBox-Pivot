...
function renderCompletedTasks() {
  let completed = findCompletedTasks();
  appendTodo(completed);
  // storage.forEach(function(todo) {
  //   if (todo.completed === true) {
  //     appendTodo(todo);
  //     //if todo's li has class of "completed" then add class
  //   }
  // }); //end of forEach
  // addFormatToCompleteds();
} // end of renderCompletedTasks

// function addFormatToCompleteds () {
//   $("li").each(function () {
//     console.log(this);
//   });
// }
...
$('.todo-list').on('click', '.completed-btn', function(){
