...
function addTenTodos(){
  // var listLength = showTenTodos.length
...
$(".show-completed-btn").on("click", function () { // this works for strikethrough
  findCompletedTasks();
  $(".true").each(function () {
...
$('.list').on("click", ".critical-btn, .high-btn, .normal-btn, .low-btn, .none-btn", function () { //this does not work for strikethrough
