...
PageManager.prototype.showCharCount = function (len) {
  if (len) {
    ...
    buttons.characterCountOutput.text("Either the input field is empty or you submitted more than 120 characters. Please submit fewer that 120 characters to enable saving tasks to page.");
  }
