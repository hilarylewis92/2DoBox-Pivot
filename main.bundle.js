...
/***/ function(module, exports, __webpack_require__) {
	...
	const Todo = __webpack_require__(6);
	const PageManager = __webpack_require__(7);
	...
	buttons.searchInputBox.on("keyup", function () {
	  ...
	  pageManager.searchForTitle(searchedForItem);
	  pageManager.searchForTask(searchedForItem);
	});

	buttons.showCompletedBtn.on("click", function () {
	...
	buttons.todoListContainer.on('blur', '.edit-title, .edit-task', function () {
