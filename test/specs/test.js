...
describe('attributes on our application',function(){
  ...
  it("should not allow more than 120 characters in either input field", function () {
    ...
    assert.equal(browser.getText(".char-count-output"), "Either the input field is empty or you submitted more than 120 characters. Please submit fewer that 120 characters to enable saving tasks to page.");
